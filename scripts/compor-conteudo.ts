...
const DADOS: MunicipioBruto[] = [
  ...
  },
  {
    ...
    linha: {
      pt: 'Cinco píeres na lagoa, uma trilha pela margem e uma capela de 1761 erguida com conchas e óleo de baleia.',
      en: 'Five piers on the lagoon, a shoreline trail, and a 1761 chapel built with shells and whale oil.',
      es: 'Cinco muelles en la laguna, un sendero por la orilla y una capilla de 1761 levantada con conchas y aceite de ballena.',
    },
    pontos: [
      {
      ...
      {
        id: 'iguaba-capela', foto: 'img/poi/iguaba-capela', tipo: 'inesperado', categoria: 'historia',
        coords: [-22.8479, -42.2298],
        nome: { pt: 'Capela de Nossa Senhora da Conceição', en: 'Chapel of Nossa Senhora da Conceição', es: 'Capilla de Nossa Senhora da Conceição' },
        teaser: {
          pt: 'Erguida em 1761 por um padre jesuíta com a ajuda dos indígenas, com conchas trituradas e óleo de baleia na argamassa.',
          en: 'Built in 1761 by a Jesuit priest with Indigenous help, with crushed shells and whale oil in the mortar.',
          es: 'Construida en 1761 por un sacerdote jesuita con la ayuda de los indígenas, con conchas trituradas y aceite de ballena en la argamasa.',
        },
        texto: {
          pt: 'A capela, a casa paroquial e o coreto foram tombados juntos em 1979. A casa e o coreto foram demolidos no fim dos anos 1980, e só a capela ficou de pé.',
          en: 'The chapel, parish house and bandstand were listed together as heritage in 1979. The house and bandstand were torn down in the late 1980s, and only the chapel still stands.',
          es: 'La capilla, la casa parroquial y el quiosco fueron declarados patrimonio juntos en 1979. La casa y el quiosco fueron demolidos a fines de los años 80, y solo quedó en pie la capilla.',
        },
        afirmacao: 'A Capela de Nossa Senhora da Conceição foi construída em 1761 pelo padre jesuíta Francisco Borges com a ajuda dos índios, com pedras, argamassa de barro, conchas trituradas e óleo de baleia; o conjunto foi tombado em 1979.',
        fonte: SETUR('iguaba-grande'),
      },
      {
        id: 'iguaba-pieres', foto: 'img/poi/iguaba-pieres', tipo: 'complementar', categoria: 'esporte',
        coords: [-22.8400, -42.2209],
        nome: { pt: 'Os píeres da orla', en: 'The shoreline piers', es: 'Los muelles de la orilla' },
        teaser: {
          pt: 'Cinco píeres entram na lagoa ao longo da orla: lugar de pescar, encostar o caiaque e ver o fim de tarde.',
          en: 'Five piers reach into the lagoon along the shore: places to fish, tie up a kayak and watch the late afternoon.',
          es: 'Cinco muelles entran en la laguna a lo largo de la orilla: lugar para pescar, amarrar el kayak y ver el atardecer.',
        },
        texto: {
          pt: 'São o Píer do Centro, o da Cidade Nova, o da antiga Prefeitura, o do antigo Cais e o do Popeye.',
          en: 'They are the Centro pier, the Cidade Nova pier, the old City Hall pier, the old Quay pier and the Popeye pier.',
          es: 'Son el muelle del Centro, el de Cidade Nova, el de la antigua Prefectura, el del antiguo Muelle y el del Popeye.',
        },
        afirmacao: 'Iguaba Grande tem cinco píeres na orla — do Centro, da Cidade Nova, da antiga Prefeitura, do antigo Cais e do Popeye —, usados para pescar, encostar caiaque ou bote e admirar a paisagem.',
        fonte: SETUR('iguaba-grande'),
      },
      {
        id: 'iguaba-ponta-da-farinha', foto: 'img/poi/iguaba-ponta-da-farinha', tipo: 'complementar', categoria: 'natureza',
        coords: [-22.8523, -42.1990],
        nome: { pt: 'Reserva da Ponta da Farinha', en: 'Ponta da Farinha Reserve', es: 'Reserva de la Ponta da Farinha' },
        teaser: {
          pt: 'Trilha leve de 1,4 km pela margem da lagoa, que começa na foz do rio Ubás e alterna trechos de caminho com pequenas praias.',
          en: 'An easy 1.4 km trail along the lagoon shore, starting at the mouth of the Ubás river and alternating stretches of path with small beaches.',
          es: 'Sendero suave de 1,4 km por la orilla de la laguna, que empieza en la desembocadura del río Ubás y alterna tramos de camino con pequeñas playas.',
        },
        texto: {
          pt: 'Do caminho se avista toda a orla de Iguaba. A visita é recomendada pela manhã, por causa da maré.',
          en: 'The whole Iguaba shoreline can be seen from the path. Morning visits are recommended because of the tide.',
          es: 'Desde el camino se ve toda la orilla de Iguaba. Se recomienda la visita por la mañana, a causa de la marea.',
        },
        afirmacao: 'A trilha da Reserva da Ponta da Farinha começa após a foz do rio Ubás, margeia a Lagoa de Araruama, tem cerca de 1,4 km e é recomendada pela manhã por causa da maré.',
        fonte: SETUR('iguaba-grande'),
      },
    ],
  },
  ...
  },
  {
    ...
    pontos: [
      ...
      {
        id: 'silva-jardim-parque-do-mico', foto: 'img/poi/silva-jardim-parque-do-mico', tipo: 'complementar', categoria: 'natureza',
        // Aproximada: a fonte da o endereco (BR-101, km 219), nao a coordenada. Fica entre a
        // rodovia e a Reserva Biologica de Poco das Antas.
        coords: [-22.5150, -42.2900],
        nome: { pt: 'RPPN Parque do Mico', en: 'Parque do Mico Reserve', es: 'Reserva Parque do Mico' },
        teaser: {
          pt: 'Reserva aberta à visitação, com trilhas e um mirante sobre o primeiro viaduto vegetado do Brasil, feito para o mico-leão-dourado cruzar a BR-101.',
          en: 'A reserve open to visitors, with trails and a lookout over Brazil’s first vegetated wildlife overpass, built so golden lion tamarins can cross the BR-101.',
          es: 'Reserva abierta a la visita, con senderos y un mirador sobre el primer viaducto vegetal de Brasil, hecho para que el mono león dorado cruce la BR-101.',
        },
        texto: {
          pt: 'São 151 hectares de Mata Atlântica, geridos pela Associação Mico-Leão-Dourado e reconhecidos como reserva particular em 2024. O viaduto, no km 218, liga a Reserva Biológica de Poço das Antas à mata do outro lado da rodovia.',
          en: 'It covers 151 hectares of Atlantic Forest, managed by the Golden Lion Tamarin Association and recognised as a private reserve in 2024. The overpass, at km 218, links the Poço das Antas Biological Reserve to the forest across the highway.',
          es: 'Son 151 hectáreas de Mata Atlántica, gestionadas por la Asociación Mico-Leão-Dourado y reconocidas como reserva privada en 2024. El viaducto, en el km 218, une la Reserva Biológica de Poço das Antas con el bosque al otro lado de la carretera.',
        },
        afirmacao: 'A RPPN Parque do Mico, em Silva Jardim (BR-101, km 219), tem 151 hectares de Mata Atlântica, é gerida pela Associação Mico-Leão-Dourado, foi reconhecida em setembro de 2024 e se liga à REBIO Poço das Antas pelo viaduto vegetado.',
        fonte: 'https://micoleao.org.br/rppn-parque-do-mico/',
      },
    ],
  },
]
